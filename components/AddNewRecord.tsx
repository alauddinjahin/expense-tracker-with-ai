...
import { FolderIcon, PlusCircleIcon, SparkleIcon, SparklesIcon } from 'lucide-react';
  ...
  return (
    <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-amber-50/50 to-orange-50/50 dark:from-amber-900/10 dark:to-orange-900/10 rounded-xl border border-amber-100/50 dark:border-amber-800/50'>
          {/* Expense Description */}
          <div className='space-y-1.5'>
            ...
            <div className='relative'>
              <input
                ...
                className='w-full pl-3 pr-12 sm:pr-14 py-2.5 bg-white/70 dark:bg-gray-800/70 border-2 border-gray-200/80 dark:border-gray-600/80 rounded-xl focus:ring-2 focus:ring-amber-500/30 focus:bg-white dark:focus:bg-gray-700/90 focus:border-amber-400 dark:focus:border-amber-400 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 text-sm shadow-sm hover:shadow-md transition-all duration-200'
              ...
              >
                {isCategorizingAI ? (
                  ...
                  <span className='text-xs'><SparkleIcon className='text-orange-800' size={18} /></span>
                )}
              </button>
            </div>
            {isCategorizingAI && (
          ...
          <div className='space-y-1.5'>
            ...
            <input
              ...
              name='date'
              id='date'
              className='w-full px-3 py-2.5 bg-white/70 dark:bg-gray-800/70 border-2 border-gray-200/80 dark:border-gray-600/80 rounded-xl focus:ring-2 focus:ring-amber-500/30 focus:bg-white dark:focus:bg-gray-700/90 focus:border-amber-400 dark:focus:border-amber-400 text-gray-900 dark:text-gray-100 text-sm shadow-sm hover:shadow-md transition-all duration-200'
              required
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-orange-50/50 to-amber-50/50 dark:from-orange-900/10 dark:to-amber-900/10 rounded-xl border border-orange-100/50 dark:border-orange-800/50'>
          {/* Category Selection */}
          <div className='space-y-1.5'>
            <label
              htmlFor='category'
            ...
            <select
              ...
              className='w-full px-3 py-2.5 bg-white/70 dark:bg-gray-800/70 border-2 border-gray-200/80 dark:border-gray-600/80 rounded-xl focus:ring-2 focus:ring-amber-500/30 focus:bg-white dark:focus:bg-gray-700/90 focus:border-amber-400 dark:focus:border-amber-400 text-gray-900 dark:text-gray-100 cursor-pointer text-sm shadow-sm hover:shadow-md transition-all duration-200'
              required
            >
              <option
                value=''
          ...
          <div className='space-y-1.5'>
            ...
            <div className='relative'>
              ...
              <input
                ...
                className='w-full pl-6 pr-3 py-2.5 bg-white/70 dark:bg-gray-800/70 border-2 border-gray-200/80 dark:border-gray-600/80 rounded-xl focus:ring-2 focus:ring-amber-500/30 focus:bg-white dark:focus:bg-gray-700/90 focus:border-amber-400 dark:focus:border-amber-400 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 text-sm font-semibold shadow-sm hover:shadow-md transition-all duration-200'
                placeholder='0.00'
                required
              />
            </div>
        ...
        <button
          type='submit'
          className='w-full relative overflow-hidden bg-gradient-to-r from-amber-600 via-orange-500 to-teal-500 hover:from-amber-700 hover:via-orange-600 hover:to-teal-600 text-white px-4 py-3 sm:px-5 sm:py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl group transition-all duration-300 border-2 border-transparent hover:border-white/20 text-sm sm:text-base'
          disabled={isLoading}
        >
          <div className='relative flex items-center justify-center gap-2'>
            {isLoading ? (
              ...
              <>
                <span className='text-lg'><PlusCircleIcon size={18} /></span>
      ...
      {alertMessage && (
        <div
          className={`mt-4 p-3 rounded-xl border-l-4 backdrop-blur-sm ${
            alertType === 'success'
              ? 'bg-orange-50/80 dark:bg-orange-900/20 border-l-orange-500 text-green-800 dark:text-orange-200'
